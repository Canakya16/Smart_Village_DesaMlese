                    ...
                    <div class="col-md-4 mb-2">
                        <figure class="figure bg-white">
                            <div class="figure-img">
                                <img src="{{ asset('storage/img/' . $data->gambar) }}" class="figure-img img-fluid" alt="{{ $data->judul_berita }}">
                            </div>
                                    ...
                                    <div class="modal-dialog modal-xl text-left">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <img src="{{ asset('storage/img/' . $data->gambar) }}" class="img-fluid mb-3" alt="{{ $data->judul_berita }}">
